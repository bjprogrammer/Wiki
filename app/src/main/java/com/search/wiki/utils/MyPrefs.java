...
public final class MyPrefs {
     ...
     * @see SharedPreferences#getLong(String, long)
     */
    public static double getDouble(Context context, final String key, final double defValue) {
     ...
     */
    public static float getFloat(Context context, final String key, final float defValue) {
    ...
    /**
     * Retrieves a Set of Strings as stored by {@link #putStringSet(Context, String, Set)}. On Honeycomb and
     * later this will call the native implementation in SharedPreferences, on older SDKs this will
     * call {@link #getOrderedStringSet(Context, String, Set)}.
     ...
     * @see #getOrderedStringSet(Context, String, Set)
     */
    ...
    public static Set<String> getStringSet(Context context, final String key, final Set<String> defValue) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            ...
            return getOrderedStringSet(context, key, defValue);
        }
    }

    /**
     * Retrieves a Set of Strings as stored by {@link #putOrderedStringSet(Context, String, Set)},
     * preserving the original order. Note that this implementation is heavier than the native
     * {@link #getStringSet(Context, String, Set)} method (which does not guarantee to preserve order).
     *
     * @param key      The name of the preference to retrieve.
     * @param defValue Value to return if this preference does not exist.
     ...
     *                            Strings.
     * @see #getStringSet(Context, String, Set)
     */
    public static Set<String> getOrderedStringSet(Context context, String key, final Set<String> defValue) {
        SharedPreferences prefs = getPreferences(context);
     ...
     * SharedPreferences.Editor, on older SDKs this will call {@link #putOrderedStringSet(Context, String,
     * Set)}.
     ...
     * @see #putOrderedStringSet(Context, String, Set)
     */
    @TargetApi(Build.VERSION_CODES.HONEYCOMB)
    public static void putStringSet(Context context, final String key, final Set<String> value) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
            ...
            putOrderedStringSet(context, key, value);
        }
    }

    /**
     * Stores a Set of Strings, preserving the order.
     * Note that this method is heavier that the native implementation {@link #putStringSet(Context, String,
     ...
     * @param key   The name of the preference to modify.
     * @param value The new value for the preference.
     * @see #putStringSet(Context, String, Set)
     * @see #getOrderedStringSet(Context, String, Set)
     */
    public static void putOrderedStringSet(Context context, String key, Set<String> value) {
        final Editor editor = getPreferences(context).edit();
     ...
     * @see Editor#clear()
     */
    public static Editor clear(Context context) {
        final Editor editor = getPreferences(context).edit().clear();
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.GINGERBREAD) {
            editor.commit();
        } else {
            editor.apply();
    ...
    public final static class Builder {
         ...
         * @return the {@link MyPrefs.Builder} object.
         */
        ...
        public void build() {
            ...
            MyPrefs.initPrefs(mContext, mKey, mMode);
        }
    }

    static public void storeIntArrayofIdsTaken(Context mContext, int val) {
        int arrp[] = getFromPrefsAllIdsTaken(mContext, true);
        arrp[arrp.length - 1] = val;
        Editor edit = mContext.getSharedPreferences("TAKEN", Context.MODE_PRIVATE).edit();
        edit.putInt("Count", arrp.length);
        int count = 0;
        for (int i : arrp) {
            edit.putInt("IntValue_" + count++, i);
            Log.d("TEST", "insert value" + i);
        }
        edit.commit();
    }

    //flag is false when not to insert key
    static public int[] getFromPrefsAllIdsTaken(Context mContex, boolean flag) {
        int[] ret;
        SharedPreferences prefs = mContex.getSharedPreferences("TAKEN", Context.MODE_PRIVATE);
    ...
    static void clearidsTaken(Context context) {
        SharedPreferences prefs = context.getSharedPreferences("TAKEN", Context.MODE_PRIVATE);
        prefs.edit().clear();
    }


    static public void storeIntArrayofIdsSnooze(Context mContext, int val) {
        int arrp[] = getFromPrefsAllIdsTaken(mContext, true);
        arrp[arrp.length - 1] = val;
        Editor edit = mContext.getSharedPreferences("SNOOZE", Context.MODE_PRIVATE).edit();
        edit.putInt("Count", arrp.length);
        int count = 0;
        for (int i : arrp) {
            edit.putInt("IntValue_" + count++, i);
    ...
    //flag is false when not to insert key
    static public int[] getFromPrefsAllIdsSnooze(Context mContex, boolean flag) {
        int[] ret;
        SharedPreferences prefs = mContex.getSharedPreferences("SNOOZE", Context.MODE_PRIVATE);
        int count = prefs.getInt("Count", 0);
        if (flag) {
            ret = new int[count + 1];
        } else {
    ...
    static void clearidsSnooze(Context context) {
        SharedPreferences prefs = context.getSharedPreferences("SNOOZE", Context.MODE_PRIVATE);
        prefs.edit().clear();
    }


    static public void storeIntArrayofIdsMissed(Context mContext, int val) {
        int arrp[] = getFromPrefsAllIdsTaken(mContext, true);
        arrp[arrp.length - 1] = val;
        Editor edit = mContext.getSharedPreferences("MISSED", Context.MODE_PRIVATE).edit();
        edit.putInt("Count", arrp.length);
        int count = 0;
        for (int i : arrp) {
            edit.putInt("IntValue_" + count++, i);
    ...
    //flag is false when not to insert key
    static public int[] getFromPrefsAllIdsMissed(Context mContex, boolean flag) {
        int[] ret;
        SharedPreferences prefs = mContex.getSharedPreferences("MISSED", Context.MODE_PRIVATE);
        int count = prefs.getInt("Count", 0);
        if (flag) {
            ret = new int[count + 1];
        } else {
    ...
    static void clearidsMissed(Context context) {
        SharedPreferences prefs = context.getSharedPreferences("MISSED", Context.MODE_PRIVATE);
        prefs.edit().clear();
    }
